...
const Car = require('../models/car');
    ...
    router.post('/save', async (req, res)=>{
        ...
        const { nome, telefone, email, marca, matricula, modelo, tipo, preco, ano, combustivel } = req.body
        ...
        if(!nome) {
            ...
            return res.status(422).json({ msg: 'O tipo de combustivel é obrigatório' });
        }
